...
interface OwnerContextValue {
  ...
  scene: string;
  /** `capabilities.<name>` from the pivot file (default ON). Business mode is
   *  outside AppProvider, so it resolves its own copy — same contract: gate a
   *  surface wherever the backend gates the matching write. */
